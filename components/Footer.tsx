...
export default function Footer() {
  return (
    <div className=' py-4 border-t-[0.5px] border-text_yellow flex md:flex-col flex-col-reverse'>
      <div className='flex flex-col-reverse md:flex-row items-center justify-center gap-6'>
        <a href="https://merchant.razorpay.com/policy/OWf9snkSTasueA/privacy" className='underline text-text_yellow/70'>Privacy Policy</a>
        <a href="https://merchant.razorpay.com/policy/OWf9snkSTasueA/terms" className='underline text-text_yellow/70'>Terms & conditions</a>
        <a href="https://merchant.razorpay.com/policy/OWf9snkSTasueA/refund" className='underline text-text_yellow/70'>Refund policy</a>
        <a href="https://merchant.razorpay.com/policy/OWf9snkSTasueA/shipping" className='underline text-text_yellow/70'>Shipping policy</a>
        <a href="https://merchant.razorpay.com/policy/OWf9snkSTasueA/contact_us" className='underline text-text_yellow/70'>Contact us</a>
      </div>
