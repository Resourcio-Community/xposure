...
export default function Navbar() {
  ...
  return (
    <div className="flex w-full justify-between fixed top-0 px-10 z-50 backdrop-blur-lg">
      ...
      <div className=" gap-7 text-sm font-poppins font-light text-white px-10 items-center tracking-wide md:flex hidden">
