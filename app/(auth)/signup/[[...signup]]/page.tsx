...
const SignUp = () => {
  const { signUpWithEmail, signInWithGoogle, user, loading } = useAuthContext();
  ...
  return (
    <div className="bg-[#0B0B0B] min-h-screen">
      ...
      <div>
        <div className="max-h-screen flex justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="w-[320px] h-[320px] mr-5 border border-spacing-1 border-[#ffe39c] p-5">
