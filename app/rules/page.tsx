      ...
      {activeTab === "themes" && (
        <div className="text-lg max-w-[50rem] space-y-4 px-4 sm:px-0">
          ...
          <ul className="list-decimal list-inside space-y-2 ml-4">
            <li>
              <b>Nature in Night</b>: Capturing the picturesque view of nature
              in the night.
            </li>
            <li>
              <b>Travel & Tourist Photography</b>: Capturing memories through
              your Travelling and Tourism.
            </li>
            <li>
              <b>Tech in nature</b>: Capture the intersection of technology and
              the natural world.
            </li>
          </ul>
          ...
          <ul className="list-decimal list-inside space-y-2 ml-4">
            ...
            <li>
              ...
              joined. In modern film and video production, B-roll describes all
              of the footage that isn&apos;t the main action.
            </li>
          </ul>
        </div>
      )}
      ...
      {activeTab === "photography" && (
        <div className="text-lg max-w-[50rem] space-y-4 px-2 sm:px-0">
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>
              Photo Dimensions: <b>3:4, 3:2, 2:3, or 4:3.</b>
            </li>
            <li>
              <b>Watermark Requirement</b>: Mandatory for all photographs.
            </li>
            <li>
              Entry Fee:
            ...
            <li>
              <b>Photo Enhancement</b>: Allowed without altering the real
              content. No manipulation; disqualification if detected.
            </li>
            <li>
              <b>Authenticity</b>: Only original works. No plagiarism.
            </li>
            <li>
              <b>Device Information</b>: Mention device name and model in the
              caption.
            </li>
            <li>
              <b>No AI-generated Works</b>: Not accepted.
            </li>
            <li>
              <b>Submission</b>: Normal submission will be in the website{" "}
              <b>Submission Form</b>. For Viewer&apos;s Choice Award
              (Photography only) you have to upload on Instagram as well.
            </li>
            <li>
              <b>Winners</b>: One Winner per Photography theme, selected by
              judges.
            </li>
            <li>
              <b>Viewer&apos;s Choice Award and Eligibility Criteria:</b>
              <ul
                className="space-y-1 list-inside ml-6"
              ...
              >
                ...
                <li>
                  Most reactions will win the Viewer&apos;s Choice Photo Award.
                </li>
                <li>
                ...
                <li>
                  Submissions only through the website&apos;s{" "}
                  <b>Submission Form</b> will be considered eligible.
                </li>
              </ul>
            </li>
            <li>
              <b>Submission Format</b>: Photos must be in <b>JPEG format</b>
            ...
            <li>
              ...
              >
                <li>
                  Any misleading information or religious hatred symbols will
                  lead to direct disqualification.
                </li>
                <li>
                  Your photograph must respect intellectual property rights and
                  not violate privacy or publicity rights.
                </li>
                <li>
                  Your photograph must not promote illegal activities or
                  violations of any law.
                </li>
              </ul>
            </li>
            <li>
              Judges&apos; Decision: Final and not subject to correspondence.
            </li>
          </ol>
        </div>
      )}
