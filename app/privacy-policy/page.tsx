...
const page = () => {
  return (
    <div className="text-white/60 pt-28 px-[10%] space-y-3 pb-16">
      ...
      <p>
        This privacy policy sets out how Resourcio Community uses and protects
        any information that you give Resourcio Community when you visit their
        website and/or agree to purchase from them.
      </p>
      <p>
        Resourcio Community is committed to ensuring that your privacy is
      ...
      <p>
        Resourcio Community may change this policy from time to time by updating
      ...
      used by anybody for direct marketing purposes if you have previously
      agreed to us using your personal information for direct marketing
      purposes, you may change your mind at any time by writing to or emailing
      us at We will not sell, distribute or lease your personal information to
      third parties unless we have your permission or are required by law to do
      so. We may use your personal information to send you promotional
      information about third parties which we think you may find interesting if
      you tell us that you wish this to happen. If you believe that any
      information we are holding on you is incorrect or incomplete, please write
      to Satgachia,purba bardhaman Purba Bardhaman WEST BENGAL 713422 . or
